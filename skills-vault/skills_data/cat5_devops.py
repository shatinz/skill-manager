...
"""
...

    {
        ...
        "version": "1.3.0",
        "tags": ["argocd", "gitops", "kubernetes", "helm", "kustomize", "multi-cluster", "declarative"],
        "trust_rating": 0.98,
        "estimated_tokens": 1750,
        "description": "Implement declarative Kubernetes continuous delivery with ArgoCD ApplicationSets, Helm chart overlays, automated drift detection, self-healing, and zero-downtime progressive rollouts.",
        "trigger_patterns": [
        ...
        "content": """# ArgoCD GitOps, Helm Orchestration & Multi-Cluster Sync
