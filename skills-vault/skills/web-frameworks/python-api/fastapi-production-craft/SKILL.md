...
description: Architect, implement, and harden production-grade FastAPI REST and async
  services with Pydantic v2 schemas, SQLAlchemy 2.0 async sessions, dependency injection,
  and standardized RFC 7807 error envelopes.
trigger_patterns:
