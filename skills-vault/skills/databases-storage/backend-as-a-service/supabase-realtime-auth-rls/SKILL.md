...
description: Architect impenetrable PostgreSQL Row-Level Security (RLS) policies,
  manage JWT role claims, and handle multi-client real-time state synchronization
